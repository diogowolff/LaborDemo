...
dataset_1b = dataset_1b(dataset_1b.RACE == 1 & dataset_1b.EMPSTAT ~= 3 & ...
    dataset_1b.RELATE == 1 & dataset_1b.EMPSTAT > 0, :);
...
table_11 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE < 35 & dataset_1b_full_time.NCHLT5 > 0 & ...
    dataset_1b_full_time.EDUC < 4, {'CBSERIAL', 'SAMPLE'})), 1);

table_12 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE < 35 & dataset_1b_full_time.NCHLT5 > 0 & ...
    dataset_1b_full_time.EDUC >= 4 & dataset_1b_full_time.EDUC <= 6, {'CBSERIAL', 'SAMPLE'})), 1);

table_13 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE < 35 & dataset_1b_full_time.NCHLT5 > 0 & ...
    dataset_1b_full_time.EDUC > 6 , {'CBSERIAL', 'SAMPLE'})), 1);
...
table_31 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE > 35 & ...
    dataset_1b_full_time.EDUC < 4 & dataset_1b_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);

table_32 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE > 35 & ...
    dataset_1b_full_time.EDUC >= 4 & dataset_1b_full_time.EDUC <= 6 & dataset_1b_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);

table_33 = size(unique(dataset_1b_full_time(dataset_1b_full_time.AGE > 35 & ...
    dataset_1b_full_time.EDUC > 6  & ...
    dataset_1b_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);
...
subtable_11 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE < 35 & dataset_1b_not_full_time.NCHILD == dataset_1b_not_full_time.NCHLT5 & ...
    dataset_1b_not_full_time.EDUC < 4, {'CBSERIAL', 'SAMPLE'})), 1);
...
subtable_12 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE < 35 & dataset_1b_not_full_time.NCHILD == dataset_1b_not_full_time.NCHLT5 & ...
    dataset_1b_not_full_time.EDUC >= 4 & dataset_1b_not_full_time.EDUC <= 6, {'CBSERIAL', 'SAMPLE'})), 1);
...
subtable_13 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE < 35 & dataset_1b_not_full_time.NCHILD == dataset_1b_not_full_time.NCHLT5 & ...
    dataset_1b_not_full_time.EDUC > 6, {'CBSERIAL', 'SAMPLE'})), 1);
...
subtable_31 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE > 35 & ...
    dataset_1b_not_full_time.EDUC < 4 & dataset_1b_not_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);

subtable_32 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE > 35 & ...
    dataset_1b_not_full_time.EDUC >= 4 & dataset_1b_not_full_time.EDUC <= 6 & dataset_1b_not_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);

subtable_33 = size(unique(dataset_1b_not_full_time(dataset_1b_not_full_time.AGE > 35 & ...
    dataset_1b_not_full_time.EDUC > 6 & dataset_1b_not_full_time.AGE <= 54, {'CBSERIAL', 'SAMPLE'})), 1);
